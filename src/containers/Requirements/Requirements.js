...
const Requirements = () => {
  ...
  <div className="requirements container">
    ...
    <img className="requirements__img"
      src="./imgs/man-laptop-v2.svg"
      alt="man_width_laptop"
    />
    <p className="requirements__text">
      Users want to find answers to their questions quickly
      and data shows that people really care about how
      quickly their pages load. The Search team announced
      speed would be a ranking signal for desktop searches
      in 2010 and as of this month (July 2018), page speed
      will be a ranking factor for mobile searches too.
    </p>
    <p className="requirements__text">
    ...
    <p className="requirements__text">
      ...
      from HTTP Archive and the Chrome User Experience Report - our
      public dataset for key UX metrics as experienced by Chrome
